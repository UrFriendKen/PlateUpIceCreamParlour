...
namespace IceCreamParlour.Customs.Items
{
    public class IceCreamChocolateFrozen : CustomItem
    {
        ...
        public override GameObject Prefab => PrefabManager.GetFrozenIceCreamInstance<IceCreamChocolate>(iceCreamMaterial: MaterialUtils.GetExistingMaterial("Chocolate"));
