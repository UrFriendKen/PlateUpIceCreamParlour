...
namespace KitchenRiggedUpgrades.Patches
{
    ...
    static class LocalViewRouter_Patch
    {
        ...
        static readonly Type GENERIC_TYPE = typeof(LimitedVariableProviderView.ViewData);
        const string DESCRIPTION = "Removed Specific Broadcast error logging for LimitedVariableProviderView.ViewData"; // Logging purpose of patch
